...
@Component({
  selector: 'app-rosconometro',
  templateUrl: './rosconometro.component.html',
  styleUrls: ['./rosconometro.component.scss']
})
export class RosconometroComponent implements OnInit {
  title(title: any) {
  ...
  constructor(
    ...
    console.log("Entré al constructor");
  }
